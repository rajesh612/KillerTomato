...
public class _requests_jspx extends com.orionserver.http.OrionHttpJspPage {
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    try {
      ...
      oracle.adfinternal.view.faces.taglib.core.layout.CorePanelGroupTag __jsp_tag_ctru14 = (oracle.adfinternal.view.faces.taglib.core.layout.CorePanelGroupTag) OracleJspRuntime.getTagHandler(pageContext, oracle.adfinternal.view.faces.taglib.core.layout.CorePanelGroupTag.class, "compiletime");
      // usage : oracle.adfinternal.view.faces.taglib.core.output.CoreObjectSpacerTag width height
      oracle.adfinternal.view.faces.taglib.core.output.CoreObjectSpacerTag __jsp_tag_ctru15 = (oracle.adfinternal.view.faces.taglib.core.output.CoreObjectSpacerTag) OracleJspRuntime.getTagHandler(pageContext, oracle.adfinternal.view.faces.taglib.core.output.CoreObjectSpacerTag.class, "compiletime");
      // usage : oracle.adfinternal.view.faces.taglib.core.layout.CorePanelGroupTag
      ...
      com.sun.faces.taglib.jsf_core.VerbatimTag __jsp_tag_ctru17 = (com.sun.faces.taglib.jsf_core.VerbatimTag) OracleJspRuntime.getTagHandler(pageContext, com.sun.faces.taglib.jsf_core.VerbatimTag.class, "compiletime");
      // usage : oracle.adfinternal.view.faces.taglib.core.nav.CoreMenuBarTag id value startDepth var
      oracle.adfinternal.view.faces.taglib.core.nav.CoreMenuBarTag __jsp_tag_ctru18 = (oracle.adfinternal.view.faces.taglib.core.nav.CoreMenuBarTag) OracleJspRuntime.getTagHandler(pageContext, oracle.adfinternal.view.faces.taglib.core.nav.CoreMenuBarTag.class, "compiletime");
      // usage : oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag id text action
      oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag __jsp_tag_ctru19 = (oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag) OracleJspRuntime.getTagHandler(pageContext, oracle.adfinternal.view.faces.taglib.core.nav.CoreCommandMenuItemTag.class, "compiletime");
                              ...
                              {
                                {
                                  ...
                                  __jsp_tag_ctru15.setWidth("10");
                                  __jsp_tag_ctru15.setHeight("10");
                                  ...
                                  {
                                    {
                                      ...
                                      if (OracleJspRuntime.checkStartBodyTagEval(__jsp_tag_starteval))
                                      {
                                        out=OracleJspRuntime.pushBodyIfNeeded(pageContext,__jsp_tag_ctru17,__jsp_tag_starteval,out);
                                        __ojsp_s_out = (com.evermind.server.http.JspCommonExtraWriter) out;
                                        do {
                                          out.write( "<iframe" + " name=\"" + "iframe"+ "\"" + " width=\"" + "80%"+ "\"" + " height=\"" + "1000"+ "\"" + " src=\"" + "/mapviewer/mapreq.html"+ "\"" + " frameborder=\"" + "0"+ "\"" + " scrolling=\"" + "auto"+ "\"" +">");
                                          out.write( "</iframe>");
                                        } while (__jsp_tag_ctru17.doAfterBody()==javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN);
                                ...
                                do {
                                  {
                                    ...
                                    __jsp_tag_ctru18.setParent(__jsp_tag_ctru6);
                                    __jsp_tag_ctru18.setId("menuSubTabsArea");
                                    __jsp_tag_ctru18.setValue("#{menuModel.model}");
                                    __jsp_tag_ctru18.setStartDepth("1");
                                    __jsp_tag_ctru18.setVar("menuSubTab");
                                    __jsp_tag_starteval=__jsp_tag_ctru18.doStartTag();
                                    if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                                    {
                                      {
                                        __jsp_tag_ctru8.setPageContext(pageContext);
                                        __jsp_tag_ctru8.setParent(__jsp_tag_ctru18);
                                        __jsp_tag_ctru8.setName("nodeStamp");
                                        __jsp_tag_starteval=__jsp_tag_ctru8.doStartTag();
                                        if (OracleJspRuntime.checkStartTagEval(__jsp_tag_starteval))
                                        {
                                          do {
                                            {
                                              ...
                                              __jsp_tag_ctru19.setParent(__jsp_tag_ctru8);
                                              __jsp_tag_ctru19.setId("menu2_mapreq");
                                              __jsp_tag_ctru19.setText("#{menuSubTab.label}");
                                              __jsp_tag_ctru19.setAction("#{menuSubTab.getOutcome}");
                                ...
                                do {
                                  {
                                    ...
                                    __jsp_tag_ctru20.setParent(__jsp_tag_ctru6);
                                    __jsp_tag_ctru20.setStyleUsage("inContextBranding");
                                    __jsp_tag_ctru20.setValue("Location, Location, Location");
